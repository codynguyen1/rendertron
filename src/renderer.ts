...
const MOBILE_USERAGENT =
    'CrOS rMozilla/5.0 (Linux; Android 8.0.0; Pixel 2 XL Build/OPD1.170816.004) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.75 Mobile Safari/537.36';
...
export class Renderer {
    ...
    async serialize(
        ...
        try {
            ...
            if (domainObj && domainObj.hostname) {
                rdomain = domainObj.hostname;
            }
        } catch (err) {
